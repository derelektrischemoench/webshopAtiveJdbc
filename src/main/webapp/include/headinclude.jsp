...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:out value="${pageContext.request.contextPath}/css/base.css" />"/>
    <link rel="stylesheet" type="text/css" href="<c:out value="${pageContext.request.contextPath}/css/mdl/material.min.css" />"/>
    <link rel="stylesheet" type="text/css" href="<c:out value="${pageContext.request.contextPath}/css/mdl/getmdl-select/getmdl-select.min.css" />">
    ...
    <script defer src="<c:out value="${pageContext.request.contextPath}/css/mdl/getmdl-select/getmdl-select.min.js" />"></script>
